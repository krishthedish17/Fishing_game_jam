...
func _ready():
	...
	if GlobalVariables.text_question == 7:
		$messages/Sprite2D.visible = true
		$messages/Label2.visible = true
		$messages/Sprite2D2.visible = true
		$messages/Label.visible = true
	...
	if GlobalVariables.text_question == 8:
		$messages/Sprite2D.visible = true
		$messages/Label2.visible = true
...
func _process(delta):
	...
	if GlobalVariables.text_question == 5:
		$Button.text = "Make him feel safe"
		$Button2.text = "Intimidate him"
		$Button3.text = "Make a joke"
		$Button4.text = "Wanna play a game"
	elif GlobalVariables.text_question == 6:
		print("2nd question")
		$Button.text = "Feel pity"
		$Button2.text = "Blatant lie"
		$Button3.text = "Make a joke"
		$Button4.text = "Preach"
